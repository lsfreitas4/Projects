...
public class VictoryController extends MenuController <VictoryView> {

    public VictoryController(Screen screen, State state) throws InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        super(screen, state, new VictoryView(screen));
        menuView.setScore(state.getLevelScore());
        menuView.setHighestScore(state.getLevelHighestScore());
    }
