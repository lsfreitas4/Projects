...
export class MyScene extends CGFscene {
    ...
    init(application) {
        ...
        this.MyUnitCubeQuad = new MyUnitCubeQuad(this, this.top, this.side, this.side, this.side, this.side, this.bottom);

        this.objects = [this.quad, this.tangram, this.MyUnitCubeQuad];

        // Labels and ID's for object selection on MyInterface
        this.objectIDs = { 'Quad': 0 , 'Tangram': 1, 'MyUnitCubeQuad' : 2};
