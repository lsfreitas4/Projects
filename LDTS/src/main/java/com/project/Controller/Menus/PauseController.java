...
public class PauseController extends MenuController <PauseView> {

    public PauseController(Screen screen, State state) throws InvocationTargetException, NoSuchMethodException, InstantiationException, IllegalAccessException {
        super(screen, state, new PauseView(screen));
    }
