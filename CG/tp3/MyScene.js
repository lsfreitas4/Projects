...
export class MyScene extends CGFscene {
    ...
    initMaterials() {
        ...
        // Wood-like material (brown diffuse, low specular)
        this.woodMaterial = new CGFappearance(this);
        this.woodMaterial.setAmbient(0.30, 0.20, 0.10, 1.0);
        this.woodMaterial.setDiffuse(0.56, 0.35, 0.20, 1.0);
        this.woodMaterial.setSpecular(0.08, 0.06, 0.04, 1.0);
        this.woodMaterial.setShininess(8.0);
