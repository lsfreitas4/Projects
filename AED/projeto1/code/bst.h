#ifndef FEUP_AED2223_BST_H
#define FEUP_AED2223_BST_H
...
class BST {
    ...
    friend class iteratorBST<Comparable>;
public:
    //explicit BST(Students *notFound);
    BST(const BST& rhs);
    ~BST( );
...
/*
template <class Comparable>
BST<Comparable>::BST(Students *notFound): root(NULL), ITEM_NOT_FOUND(notFound)
{ }*/
